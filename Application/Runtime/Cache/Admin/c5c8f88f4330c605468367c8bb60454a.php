	    ...
	    <div class="xs">
	  	    ...
	  	    <div class="tab-content">
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal" action="/work/index.php/Admin/User/update"  enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="auth" id="selector1" class="form-control1">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
						        ...
						        <img src="/work/Public/Uploads/<?php echo ($vo['pic']); ?>" style="width:50px;" alt="">
					        </div>
					    </div>
					    <div class="form-group">
