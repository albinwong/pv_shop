	    ...
	    <div class="xs">
	  	    ...
	  	    <div class="tab-content">
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal" action="/work/pv_shop/index.php/Admin/View/update" enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
					        <label for="txtarea1" class="col-sm-2 control-label">轮播图</label>
							<div class="col-sm-8">
						        <input type="file" name="pic"><img style="width:50%;height:50%;" src="/work/pv_shop/Public/Uploads/banners/<?php echo ($vo["pic"]); ?>" alt="">
					        </div>
					    </div>
						<div class="form-group">
