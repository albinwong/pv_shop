			    ...
			    <div class="table-responsive">
			      <table class="table table-bordered">
			        ...
			        <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr>
			            ...
			            <td><img src="/work/pv_shop/Public/Uploads/banners/<?php echo ($vo['pic']); ?>" style="width:50px;" alt=""></td>
			            <td><?php echo (getviewstatus($vo['status'])); ?></td>
			            <td>
			            	<a href="<?php echo U('admin/view/delete',array('id'=>$vo['id']));?>">删除</a>||
							<a href="<?php echo U('admin/view/edit',array('id'=>$vo['id']));?>">修改</a>
						</td>
