	    ...
	    <div class="xs">
	  	    ...
	  	    <div class="tab-content">
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal" action="/work/index.php/Admin/Cate/insert"  enctype="multipart/form-data" method="post">	
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control1" id="focusedinput" placeholder="分类说明" type="text" name="intro" value="<?php echo ($vo["intro"]); ?>">
							</div>
						</div>
						<div class="form-group">
