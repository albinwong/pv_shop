			    ...
			    <div class="table-responsive">
			      <table class="table table-bordered">
			        ...
			        <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr>
			            ...
			            <td><img src="/work/Public/Uploads/cate/<?php echo ($vo['logo']); ?>" style="width:110%;" alt=""></td>
			            <td><?php echo ($vo['name']); ?></td>
			            <td><?php echo (getcatename($vo['pid'])); ?></td>
			            <td>
		            		<p title="<?php echo ($vo['intro']); ?>" style="width:40px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo ($vo['intro']); ?></p>
			            </td>
			            <td>
