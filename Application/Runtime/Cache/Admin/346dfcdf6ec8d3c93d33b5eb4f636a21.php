	    ...
	    <div class="xs">
	  	    ...
	  	    <div class="tab-content">
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal" action="/work/index.php/Admin/Goods/insert"  enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control1" id="focusedinput" placeholder="请输入商品规格" type="text" name="repertory">
							</div>
						</div>
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">销量</label>
							<div class="col-sm-8">
								<input class="form-control1" id="focusedinput" placeholder="商品销量" type="text" name="sales">
							</div>
						</div>
					    <div class="form-group">
