...
<body>
    ...
    <div class="banner">
        <div class="swiper-container gallery-top">
            <div class="swiper-wrapper">
                <?php if(is_array($view)): foreach($view as $key=>$lb): if($lb["status"] == 0): ?><a class="swiper-slide" href="/work/index.php/Home/Index/glist?id=<?php echo ($lb["cate_id"]); ?>" style="background-image:url(/work/Public/Uploads/banners/<?php echo ($lb["pic"]); ?>)"></a><?php endif; endforeach; endif; ?>
            </div>
            <div class="swiper-button-next swiper-button-white"></div>
        </div>
        <div class="swiper-container gallery-thumbs">
            <div class="swiper-wrapper">
                <?php if(is_array($view)): foreach($view as $key=>$lb): if($lb["status"] == 0): ?><div class="swiper-slide" style="background-image:url(/work/Public/Uploads/banners/<?php echo ($lb["pic"]); ?>)"></div><?php endif; endforeach; endif; ?>
            </div>
        </div>
    </div>
    <div class="logo">
    ...
    <?php if(is_array($res)): foreach($res as $key=>$vo): if($key%2 == 0): ?><a href="/work/index.php/Home/Index/glist?id=<?php echo ($vo["id"]); ?>" class="inad_1">
            	<ul class="inad_1_l">
        ...
        <?php else: ?>
            <a href="/work/index.php/Home/Index/glist?id=<?php echo ($vo["id"]); ?>" class="inad_1">
                <div class="inad_1_rl">
                    <div class="inad_1_rt"><?php echo ($vo["name"]); ?>&nbsp;&nbsp;<b>&gt;</b></div>
                    <div class="inad_1_rm"><?php echo ($vo["intro"]); ?></div>
                </div>
